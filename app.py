...
urls = ['https://munity.vulcanwm.repl.co/', 'https://ovaleyes.ovaleyes.repl.co/', 'https://drinks-cabin.vulcanwm.repl.co/', 'https://frank.vulcanwm.repl.co/', 'https://wegreek.vulcanwm.repl.co/', 'https://imposter.vulcanwm.repl.co/', 'https://jasonism.vulcanwm.repl.co/', 'https://BesucheResort.vulcanwm.repl.co/']
